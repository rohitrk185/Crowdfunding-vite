...
const FundCard = ({
  ...
  return (
    <div
      className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer shadow-xl shadow-zinc-900"
      onClick={handleClick}
    >
      <img
        src={image}
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="block">
          <h3 className="font-poppins font-semibold text-[16px] text-black text-left leading-[26px] truncate">
            {title}
          </h3>
